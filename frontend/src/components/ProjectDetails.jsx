...
function ProjectDetails(props) {
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch("user/auth/employee/" + user.userid + "/" + props.project._id, {
            method: 'DELETE',
            session: {
                authorization: user
            }
    ...
    const handlePayment = async () => {
        ...
        const response = await fetch("user/auth/admin/" + employeeId + "/projects/" + props.project._id, {
            method: 'PATCH',
